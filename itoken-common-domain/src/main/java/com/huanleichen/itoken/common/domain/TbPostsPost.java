package com.huanleichen.itoken.common.domain;

import javax.persistence.*;
import java.math.BigDecimal;
import java.util.Date;

@Table(name = "itoken_service_posts.tb_posts_post")
public class TbPostsPost extends BaseDomain {
    private static final long serialVersionUID = -201027395186301164L;
    /**
     * 文章编码
     */
    @Id
